    ...
    <div id="sidebar-collapse">
        ...
        <ul class="side-menu metismenu">
            ...
            <li class="{{ (request()->is('guest/pendaftaran/riwayat'))? 'active' : '' }}">
                <a href="{{ route('guest.pendaftaran.riwayat') }}"><i class="sidebar-item-icon fa fa-calendar"></i>
            ...
            <li class="{{ (request()->is('siswa/pembayaran')) ? 'active' : '' }}">
                <a href="{{ route('pembayaran.index') }}"><i class="sidebar-item-icon bi bi-cash"></i>
